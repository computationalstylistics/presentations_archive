...
- Word-by-word mapping: word embeddings + simple grammatical rules + heurisitcs
...
- Three approaches to overcome the issue:
    ...
    - Feature engineering (input based on traditional translation method)
